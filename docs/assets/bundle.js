  ...
  function () {
          ...
          function (e, n, o) {
            ...
            function r(e, n) {
              ...
              for (var r, i = o.length,
                s = 0; s < i; s++) if ((r = n.match(t(o[s]))) && r.length > 1) return r[1].replace(/_/g, ".");
              return !1
            }
            function i(e, n, o) {
              for (var t, i, s = e.length,
                a = 0; a < s; a++) if ("function" == typeof e[a].test ? !0 === e[a].test(o) && (t = e[a].name) : o.ua.indexOf(e[a].userAgent) > -1 && (t = e[a].name), t) {
    ...
    window.main = new n,
      window.onload = function () {
        ...
        var rqstJson = getRequest();
        fetch('https://avoscloud.com/1.1/classes/App/' + rqstJson.objectId, {
          headers: {
            "Content-Type": "application/json",
            "X-LC-Id": "kscF2nXMoGQCJDLf2MQxYTGm-gzGzoHsz",
            "X-LC-Key": "Stp7wCtlaybGlMbDJ4ApYbQL",
          },
          method: 'GET',
