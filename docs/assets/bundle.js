        ...
        var e = {
            ...
            n = function () {
                this.showOrHideLoadingView = function (n) {
                    ...
                    this.showErotsInstall = function () {
                        this.showOrHideLoadingView(0);
                        var i = document.getElementById(e.ShortcutIconID),
                            s = document.getElementById(e.ShortcutNameID),
                            a = document.getElementById(e.ShortcutDescriptionID),
                            ...
                            c = document.getElementById(e.ShortcutShowActionsID);
                        i.src = "./favicon.png";
                        document.title = "Erots 脚本商店",
                            s.innerText = "Erots 脚本商店",
                            a.innerText = "JSBox 第三方脚本商店，好玩有趣的脚本都在这里。",
                            u.className = "";
                            d.innerText = "获取商店"
                        d.onclick = function (e) {
                            var link = "jsbox://import?url=https%3A%2F%2Fgithub.com%2FLiuGuoGY%2FJSBox-addins%2Fraw%2Fmaster%2FErots%2F.output%2FErots.box";
                            if (is_weixin()) {
                                var qrurl = "./instruction.html";
                                e.preventDefault(), document.location = qrurl;
                            } else {
        ...
        window.main = new n,
            window.onload = function () {
                ...
                if (rqstJson.objectId) {
                    ...
                    return void window.main.showErotsInstall();
                }
            },
